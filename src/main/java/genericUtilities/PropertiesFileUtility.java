...
public class PropertiesFileUtility {
	...
	/**
	 * This method will read data from properties file and return the value to caller
	 * @param key
	 * @return String
	 * @throws Throwable
	 */
	...
	{
		// return pro.get(value).toString(); // keep the return type as Object or type it to String as done
